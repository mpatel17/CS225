...
size_t binsert(std::vector<T> elements, const C& val, int front, int back) {
    
//std::cout << "beginning of binsert" << std::endl;
...
std::cout << "index found" << std::endl;
        ...
        return binsert(elements, val, front, back);
    }
...
//std::cout << "beginning of insertion function" << std::endl;
//std::cout << elements.size() << std::endl;

/*    if(elements.empty() || elements[0] > val || elements[0] == val) {
//std::cout << "insert at 0" << std::endl;
        return 0;
    }

    if(elements.back() < val || elements.back() == val) {
//std::cout << "insert at back" << std::endl;
        return elements.size();
    }

//std::cout << "about to binsert" << std::endl;

    return binsert(elements, val, 0, elements.size()-1);*/
